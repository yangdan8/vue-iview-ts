...
export declare class TimePicker extends Vue {
  ...
  */
  public $emit(eventName: 'on-change', value: string): this;
  /**
  * 弹出浮层和关闭浮层时触发
  */
  public $emit(eventName: 'on-open-change', value: boolean): this;
  /**
  * 点击确定按钮时触发
  */
  public $emit(eventName: 'on-ok'): this;
  /**
  * 在清空日期时触发
  */
  public $emit(eventName: 'on-clear'): this;
}

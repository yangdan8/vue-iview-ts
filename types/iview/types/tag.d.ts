...
export declare class Tag extends Vue {
   ...
   * 你也可以自定义颜色值。
   */
  public color?: 'default' | 'primary' | 'success' | 'warning' | 'error' | 'blue' | 'green' | 'red' | 'yellow' | 'pink' | 'magenta' | 'volcano' | 'orange' | 'gold' | 'lime' | 'cyan' | 'geekblue' | 'purple';
  /**
   ...
   * 关闭时触发
   */
  public $emit(eventName: 'on-close', event: object, name: string): this;
}
